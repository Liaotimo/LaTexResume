...
%\fancyfoot[R]{\small{Page \thepage \hspace{1pt} of \pageref{LastPage}}} % add page numbering using lastpage for total page counthttps://www.overleaf.com/project/65be5f2bce75cfedde5c2c29
...
\usepackage[style=apa, maxnames=50]{biblatex}
\addbibresource{patents_and_publications.bib}
% removes number label and supress label altogether
\DeclareFieldFormat{labelnumberwidth}{}
% increase sep between entries based on default itemsep
...
\begin{center}
    \textbf{\Huge \scshape Timothy Liao} \\ \vspace{1pt}
...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed and maintained ETL/ELT data pipelines for ingestion and normalization of external biodata databases}
	  ...
	  \resumeItem{Implemented robust data quality checks within ETL/ELT workflows to ensure accuracy, consistency, and completeness of processed data}
        \resumeItem{Engineered effective data models and schemas to support data integrity and facilitate integration with downstream applications}
    \resumeItemListEnd 
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
		\resumeItem{\emph{Formerly Associate Scientist I, Research Associate II, Research Associate I}}
		\resumeItem{Engineered several key enzymes for improved functions using high-throughput workflows culminating in inventorship on 2 patent applications}        	
