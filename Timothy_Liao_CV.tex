...
% Bibliography
% removes "Reference" header from bibliography 
%\usepackage{etoolbox}
...
%-------------------------------------------
    ...
    \resumeSubheading
      {Graduate Student Researcher}{Jan 2014 - May 2016}
...
\nocite{*}
\bibliographystyle{unsrt} \bibliography{patents} 
%	\resumeSubHeadingListStart
...
\bibliographypatents{all}
\bibliographystylejournal{plain}
\bibliographypublications{all}
